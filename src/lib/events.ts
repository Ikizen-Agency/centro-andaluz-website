...
export const events: Event[] = [
  {
    ...
    artists: [
      { name: 'Isabella Reyes', instrument: 'Lead Dancer', image: 'member-2' },
      { name: 'Javier Gomez', instrument: 'Guitarist', image: 'member-3' },
      { name: 'Elena Torres', instrument: 'Dancer', image: 'member-6' },
    ],
  },
  {
    ...
    artists: [
        { name: 'Javier Gomez', instrument: 'Solo Guitarist', image: 'member-3' },
    ]
  },
  {
    ...
    artists: [
        { name: 'Elena Torres', instrument: 'Instructor', image: 'member-6' },
        { name: 'Sofia Moreno', instrument: 'Assistant', image: 'member-4' },
    ]
  },
  {
    ...
    artists: [
        { name: 'Mateo Castillo', instrument: 'Host & Sommelier', image: 'member-5' },
    ]
  },
];
